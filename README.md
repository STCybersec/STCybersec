...
I'm **Sanele Siyabonga Thusi**, a **Hybrid Cybersecurity & Data/Automation Specialist**. My work spans **security operations, threat detection, automation, analytics, and business system integration**. I actively design and implement **real-world lab simulations, security controls, data-driven dashboards, automated processes, and cloud-enabled solutions**.

I focus on creating measurable outcomes for both **security defense** and **enterprise operations efficiency**.

---

## 🛡️ Pillar 1: Cybersecurity

**Focus Areas**
- **SOC Operations:** SIEM alerting, log parsing, custom rule creation & tuning (Wazuh, Splunk, OSSEC, Suricata)  
- **Threat Detection & Blue Teaming:** File integrity monitoring (FIM), unauthorized access tracking, privilege escalation alerts, endpoint visibility  
- **Purple Teaming:** Mapping adversary techniques to defensive detections, MITRE ATT&CK alignment, detection gap analysis, alert validation  
- **Controlled Adversary Simulation:** Network enumeration, payload delivery, reverse shells, stealth scanning, evasion testing for detection validation  
- **Linux Mastery:** Kali Linux navigation, Bash scripting, system hardening, logging & service monitoring  
...
## 📊 Pillar 2: Data, Automation & Systems
...
If you're working in **cybersecurity, data analytics, automation, or system integration**, feel free to reach out:
